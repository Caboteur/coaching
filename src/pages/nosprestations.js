...
function Prestation() {
  return (
    ...
    <li><br/><p id="strongword" style={{textAlign: "left",color: "#ffd9da"}}>Ateliers:</p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<p id="strongword" style={{color:"#ffc107"}}> &nbsp; &nbsp; &nbsp;Café Clown</p>
C’est un atelier ludique et bienveillant qui mêle improvisation, clown de théâtre et coaching.<br />
Venez vivre une expérience personnelle de changement soutenue par une dynamique collective!<br />

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p id="strongword" style={{color:"#ffc107"}}> &nbsp; &nbsp; &nbsp; Carrière Coach</p>
Vous êtes en recherche de sens dans votre vie professionnelle, vous vous posez des questions pour mener à bien une période de transition, vous êtes à un moment clé de votre parcours et vous recherchez un accompagnement afin de mettre en œuvre un plan d’actions adapté pour réaliser votre projet professionnel, l’atelier « Carrière Coach » répond à votre demande.
